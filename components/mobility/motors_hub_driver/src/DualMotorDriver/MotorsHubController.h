...
class MotorsHubController : public CommandParser{
  public:
    ...
    // Back left
    // POWER 13, DIRECTION 12, SPEED 26, (adac) CURRENT 1, onewire TEMPERATURE INDEX1, HALL A (yellow) 5, B (green) 6, C (blue) 7, ReverseSping false
    Motor motorA = Motor(13, 12, 26, 1, 1, 5, 6, 7, false, 180);//250
    ...
    Motor motorB = Motor(32, 21, 25, 0, 0, 2, 3, 4, true, 180);
